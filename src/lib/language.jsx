...
export const translations = {
  ...
  he: {
    ...
    issuedEquipmentTitle: "ציוד מנופק של",
    previouslyUsedEquipment: "ציוד שהיה בשימוש בעבר ונמצא במחסן",
    previouslyAssignedTo: (name) => `ציוד זה הונפק בעבר ל${name} וכעת זמין במחסן.`,
    issueNewOrReissue: "הנפק חדש או הנפק מחדש",
    ...
    processing: "מעבד...",
    noEquipmentIssued: "אין ציוד מנופק כעת",
    loadingHistory: "(טוען...)",
    loadingHistoricalAssignments: "טוען היסטוריית ההנפקות...",
    ...
    noOtherEquipmentAvailable: "אין ציוד אחר זמין להנפקה",
    issueEquipmentToSign: "הנפק ציוד כדי לקבל חתימה",
    supplantingItems: "פריטים נלווים",
    addSupplantingItem: "הוסף פריט נלווה...",
    warningItemIssued: (currentHolder, newHolder) => `אזהרה: פריט זה מנופק כעת ל${currentHolder}. האם אתה בטוח שברצונך להנפיק אותו ל${newHolder}? פעולה זו תזכה את המחזיק הקודם באופן אוטומטי.`,
    warningItemRepair: (newHolder) => `אזהרה: פריט זה נמצא בתיקון. האם אתה בטוח שברצונך להנפיק אותו ל${newHolder}?`,
    confirmRevert: (count) => `יש לך ${count} הנפקות שלא נחתמו. יציאה ממסך זה תבטל את השינויים. האם אתה בטוח?`,
    noInventoryToAssign: "אין מלאי זמין להנפקה.",
    signOffTitle: "אישור וחתימה על הנפקת ציוד",
    acknowledgeEquipment: "ציוד לאישור",
    soldierSignature: "חתימת חייל",
    witnessName: "שם העד (אופציונלי)",
    witnessSignature: "חתימת העד",
    completeAssignment: "סיים הנפקה",
    cancel: "ביטול",
    error: "שגיאה",
    ...
    issuedEquipment: "ציוד מנופק",
    issuedTo: "מנופק ל",
    condition: "מצב",
    issued: "מנופק",
    noIssuedEquipmentFound: "לא נמצא ציוד מנופק",
    ...
    searchEquipmentByNameSerialHolder: "חפש לפי שם ציוד, מספר סידורי, או שם חייל מנופק...",
    status: "סטטוס",
    ...
    assignmentHistory: "היסטוריית הנפקות",
    noAssignmentHistory: "לא נמצאה היסטוריית הנפקות לפריט זה.",
    ...
    issueEquipment: "הנפק ציוד",
    selectSoldierToIssue: "בחר חייל להנפקה",
    searchForSoldier: "חפש חייל...",
    issuing: "מנפיק...",
    completeIssuance: "סיים הנפקה",
    soldierManagement: "ניהול חיילים",
    soldierManagementSubtitle: "נהל פרופילי חיילים והנפקות ציוד",
    ...
    soldierHasNoEquipment: "לחייל זה אין ציוד מנופק.",
    ...
    itemAlreadyPending: "פריט זה כבר ממתין להנפקה.",
    inventoryItemAlreadyPending: "פריט מלאי זה כבר ממתין להנפקה.",
    errorProcessingReassignment: "שגיאה בעיבוד ההנפקה מחדש. אנא נסה שוב.",
    errorCompletingAssignments: "שגיאה בסיום ההנפקות. אנא נסה שוב.",
    errorSavingAssignment: "אירעה שגיאה בשמירת ההנפקה. אנא נסה שוב.",
    ...
    addAndIssue: "הוסף והנפק",
    quantity: "כמות",
    available: "זמין",
    noSoldierSelected: "לא נבחר חייל",
    pendingAssignments: "הנפקות ממתינות",
    currentlyIssuedTo: "מנופק כעת ל",
