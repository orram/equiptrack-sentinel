      ...
      <Table className="min-w-full divide-y divide-slate-200">
        <TableHeader>
          <TableRow className="bg-slate-50">
            ...
            <TableHead colSpan={subHeaders.length} className={`text-center font-bold text-white bg-slate-800 ${isHe ? 'sticky right-0 z-10 border-l-2 border-slate-400' : 'border-r-2 border-slate-400'}`}>
